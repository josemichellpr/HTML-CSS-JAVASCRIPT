...
const inputEl2 = document.getElementById("inputEl2") /* 1ER cuadro de texto - INPUT  */
const OUTPUT = document.getElementById("output") /* Donde se renderizaba mi diálogo para indicar
