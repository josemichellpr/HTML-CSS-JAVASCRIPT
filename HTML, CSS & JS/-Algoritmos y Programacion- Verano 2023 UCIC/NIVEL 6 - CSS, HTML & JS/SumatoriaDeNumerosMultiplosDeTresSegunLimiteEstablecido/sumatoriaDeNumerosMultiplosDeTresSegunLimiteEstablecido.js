...
let i = 0
let inicioDeSumatoria=Math.floor(INICIO_DE_SUMATORIA.value)
let finDeSumatoria=Math.floor(FIN_DE_SUMATORIA.value)
let variable = inicioDeSumatoria
let suma_de_multiplos_de_tres = 0
